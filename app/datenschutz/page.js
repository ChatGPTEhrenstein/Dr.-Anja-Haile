      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <Accordion type="single" collapsible className="w-full space-y-4">
            <AccordionItem value="overview" className="border border-amber-200 rounded-lg">
              <AccordionTrigger className="text-left px-6 py-4 text-amber-900 font-semibold">
                1. Datenschutz auf einen Blick
              </AccordionTrigger>
              <AccordionContent className="px-6 pb-4">
                <div className="space-y-4 text-amber-700">
                  <h3 className="font-semibold text-amber-900">Allgemeine Hinweise</h3>
                  <p>Die folgenden Hinweise geben einen einfachen Überblick darüber, was mit Ihren personenbezogenen Daten passiert, wenn Sie diese Website besuchen. Personenbezogene Daten sind alle Daten, mit denen Sie persönlich identifiziert werden können.</p>
                  
                  <h3 className="font-semibold text-amber-900">Datenerfassung auf dieser Website</h3>
                  <p>Die Datenverarbeitung auf dieser Website erfolgt durch den Websitebetreiber. Dessen Kontaktdaten können Sie dem Impressum dieser Website entnehmen.</p>
                  
                  <h3 className="font-semibold text-amber-900">Ihre Rechte</h3>
            ...
            <AccordionItem value="responsible" className="border border-amber-200 rounded-lg">
              <AccordionTrigger className="text-left px-6 py-4 text-amber-900 font-semibold">
            ...
            <AccordionItem value="data-collection" className="border border-amber-200 rounded-lg">
              <AccordionTrigger className="text-left px-6 py-4 text-amber-900 font-semibold">
                3. Datenerfassung auf dieser Website
              </AccordionTrigger>
              <AccordionContent className="px-6 pb-4">
                <div className="space-y-4 text-amber-700">
                  <h3 className="font-semibold text-amber-900">Kontaktformular</h3>
                  <p>Wenn Sie uns per Kontaktformular Anfragen zukommen lassen, werden Ihre Angaben aus dem Anfrageformular inklusive der von Ihnen dort angegebenen Kontaktdaten zwecks Bearbeitung der Anfrage und für den Fall von Anschlussfragen bei uns gespeichert. Diese Daten geben wir nicht ohne Ihre Einwilligung weiter.</p>
                  
                  <h3 className="font-semibold text-amber-900">Server-Log-Dateien</h3>
            ...
            <AccordionItem value="booking-system" className="border border-amber-200 rounded-lg">
              <AccordionTrigger className="text-left px-6 py-4 text-amber-900 font-semibold">
                4. Terminbuchungssystem (GoHighLevel)
              </AccordionTrigger>
              <AccordionContent className="px-6 pb-4">
                <div className="space-y-4 text-amber-700">
                  <h3 className="font-semibold text-amber-900">Art und Umfang der Datenverarbeitung</h3>
                  ...
                  <h3 className="font-semibold text-amber-900">Übertragene Daten</h3>
                  <ul className="list-disc list-inside ml-4 space-y-1">
                  ...
                  <h3 className="font-semibold text-amber-900">Rechtsgrundlage</h3>
                  ...
                  <h3 className="font-semibold text-amber-900">Datenschutz bei GoHighLevel</h3>
            ...
            <AccordionItem value="rights" className="border border-amber-200 rounded-lg">
              <AccordionTrigger className="text-left px-6 py-4 text-amber-900 font-semibold">
                5. Ihre Rechte
              </AccordionTrigger>
              <AccordionContent className="px-6 pb-4">
                <div className="space-y-4 text-amber-700">
                  ...
                  <h3 className="font-semibold text-amber-900">Recht auf Auskunft</h3>
                  <p>Sie können Auskunft über Ihre von uns verarbeiteten personenbezogenen Daten verlangen.</p>
                  
                  <h3 className="font-semibold text-amber-900">Recht auf Berichtigung</h3>
                  <p>Sie haben ein Recht auf Berichtigung unrichtiger oder unvollständiger personenbezogener Daten.</p>
                  
                  <h3 className="font-semibold text-amber-900">Recht auf Löschung</h3>
                  ...
                  <h3 className="font-semibold text-amber-900">Recht auf Einschränkung</h3>
                  <p>Sie können die Einschränkung der Verarbeitung Ihrer personenbezogenen Daten verlangen.</p>
                  
                  <h3 className="font-semibold text-amber-900">Recht auf Widerspruch</h3>
                  <p>Sie können jederzeit gegen die Verarbeitung Ihrer personenbezogenen Daten Widerspruch einlegen.</p>
                  
                  <h3 className="font-semibold text-amber-900">Recht auf Datenübertragbarkeit</h3>
            ...
            <AccordionItem value="therapy-data" className="border border-amber-200 rounded-lg">
              <AccordionTrigger className="text-left px-6 py-4 text-amber-900 font-semibold">
                6. Besondere Bestimmungen für Therapiedaten
              </AccordionTrigger>
              <AccordionContent className="px-6 pb-4">
                <div className="space-y-4 text-amber-700">
                  <h3 className="font-semibold text-amber-900">Schweigepflicht</h3>
                  ...
                  <h3 className="font-semibold text-amber-900">Therapiedokumentation</h3>
                  ...
                  <h3 className="font-semibold text-amber-900">Aufbewahrungsfristen</h3>
                  <p>Therapieunterlagen werden gemäß der Berufsordnung für Psychotherapeuten für mindestens 10 Jahre aufbewahrt.</p>
                  
                  <h3 className="font-semibold text-amber-900">Übermittlung an Dritte</h3>
            ...
            <AccordionItem value="contact" className="border border-amber-200 rounded-lg">
              <AccordionTrigger className="text-left px-6 py-4 text-amber-900 font-semibold">
              ...
              <AccordionContent className="px-6 pb-4">
                <div className="space-y-4 text-amber-700">
                  ...
                  <h3 className="font-semibold text-amber-900">Beschwerde bei Aufsichtsbehörde</h3>
