      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <Accordion type="single" collapsible className="w-full space-y-4">
            <AccordionItem value="contact-info" className="border border-blue-200 rounded-lg">
              ...
              <AccordionContent className="px-6 pb-4">
                <div className="space-y-4 text-blue-700">
                  <div>
                    <h3 className="font-semibold text-blue-900 mb-2">Praxisinhaber:</h3>
                    <p>Dr. Anja Haile<br />
                    Psychologische Psychotherapeutin</p>
                  </div>
                  
                  <div>
                    <h3 className="font-semibold text-blue-900 mb-2">Anschrift:</h3>
                  ...
                  <div>
                    <h3 className="font-semibold text-blue-900 mb-2">Kontakt:</h3>
            ...
            <AccordionItem value="professional-info" className="border border-blue-200 rounded-lg">
              <AccordionTrigger className="text-left px-6 py-4 text-blue-900 font-semibold">
              ...
              <AccordionContent className="px-6 pb-4">
                <div className="space-y-4 text-blue-700">
                  <div>
                    <h3 className="font-semibold text-blue-900 mb-2">Berufsbezeichnung:</h3>
                    <p>Psychologische Psychotherapeutin<br />
                    (verliehen in Deutschland)</p>
                  </div>
                  
                  <div>
                    <h3 className="font-semibold text-blue-900 mb-2">Zuständige Kammer:</h3>
                  ...
                  <div>
                    <h3 className="font-semibold text-blue-900 mb-2">Kassenzulassung:</h3>
                    <p>Kassenzulassung bei der Kassenärztlichen Vereinigung Bayern (KVB)</p>
                  </div>
                  
                  <div>
                    <h3 className="font-semibold text-blue-900 mb-2">Berufsrechtliche Regelungen:</h3>
            ...
            <AccordionItem value="responsibility" className="border border-blue-200 rounded-lg">
              <AccordionTrigger className="text-left px-6 py-4 text-blue-900 font-semibold">
            ...
            <AccordionItem value="disclaimer" className="border border-blue-200 rounded-lg">
              <AccordionTrigger className="text-left px-6 py-4 text-blue-900 font-semibold">
                Haftungsausschluss
              </AccordionTrigger>
              <AccordionContent className="px-6 pb-4">
                <div className="space-y-4 text-blue-700">
                  <div>
                    <h3 className="font-semibold text-blue-900 mb-2">Haftung für Inhalte:</h3>
                    <p>Als Diensteanbieter sind wir gemäß § 7 Abs.1 TMG für eigene Inhalte auf diesen Seiten nach den allgemeinen Gesetzen verantwortlich. Nach §§ 8 bis 10 TMG sind wir als Diensteanbieter jedoch nicht unter der Verpflichtung, übermittelte oder gespeicherte fremde Informationen zu überwachen oder nach Umständen zu forschen, die auf eine rechtswidrige Tätigkeit hinweisen.</p>
                  </div>
                  
                  <div>
                    <h3 className="font-semibold text-blue-900 mb-2">Haftung für Links:</h3>
                    <p>Unser Angebot enthält Links zu externen Websites Dritter, auf deren Inhalte wir keinen Einfluss haben. Deshalb können wir für diese fremden Inhalte auch keine Gewähr übernehmen. Für die Inhalte der verlinkten Seiten ist stets der jeweilige Anbieter oder Betreiber der Seiten verantwortlich.</p>
                  </div>
                  
                  <div>
                    <h3 className="font-semibold text-blue-900 mb-2">Urheberrecht:</h3>
            ...
            <AccordionItem value="technical" className="border border-blue-200 rounded-lg">
              <AccordionTrigger className="text-left px-6 py-4 text-blue-900 font-semibold">
              ...
              <AccordionContent className="px-6 pb-4">
                <div className="space-y-4 text-blue-700">
                  <div>
                    <h3 className="font-semibold text-blue-900 mb-2">Webdesign und Entwicklung:</h3>
                  ...
                  <div>
                    <h3 className="font-semibold text-blue-900 mb-2">Terminbuchung:</h3>
